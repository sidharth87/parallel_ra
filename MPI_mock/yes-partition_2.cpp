...
//SouffleProgram *newInstance_yes_partition(){return new Sf_yes_partition_2;}
//SymbolTable *getST_yes_partition(SouffleProgram *p){return &reinterpret_cast<Sf_yes_partition_2*>(p)->symTable;}
