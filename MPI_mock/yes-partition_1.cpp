...
//SouffleProgram *newInstance_yes_partition1(){return new Sf_yes_partition_1;}
//SymbolTable *getST_yes_partition1(SouffleProgram *p){return &reinterpret_cast<Sf_yes_partition_1*>(p)->symTable;}
